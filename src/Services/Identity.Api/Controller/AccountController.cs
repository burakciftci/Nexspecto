...
public class AccountController : ControllerBase
{
    ...
    private readonly IPasswordHasher<Models.ApplicationUser> _passwordHasher = new PasswordHasher<Models.ApplicationUser>();
    ...
    public async Task<IActionResult> CreateUser(CreateUserViewModel model)
    {
        ...
        var role = await _applicationDbContext.Roles.FirstOrDefaultAsync(i => i.Name == model.Role);
        if (role is null)
        {
